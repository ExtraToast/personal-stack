...
class ProjectControllerTest {
    ...
    private fun project(id: ProjectId = ProjectId.random()) =
        Project(id, "Personal Stack", "personal-stack", "", Instant.now(), Instant.now())
                ...
                post("/api/v1/projects")
                    ...
                    .content(
                        objectMapper.writeValueAsString(
                            mapOf("name" to "Personal Stack", "slug" to "personal-stack"),
                        ),
                    ),
            ).andExpect(status().isCreated)
            .andExpect(jsonPath("$.slug").value("personal-stack"))
