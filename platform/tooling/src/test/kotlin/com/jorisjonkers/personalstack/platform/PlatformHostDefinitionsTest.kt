...
class PlatformHostDefinitionsTest {
    ...
    fun `gtx 960m host imports game streaming service`() {
        ...
        assertThat(module)
            ...
            .contains("WOLF_RENDER_NODE = \"/dev/dri/renderD129\"")
            ...
            .contains("uid = 1001")
            .contains("localGamesMount = \"/srv/game-streaming\"")
            .contains("localRomsMount = \"\${localGamesMount}/roms\"")
            .contains("device = \"/dev/disk/by-uuid/1120-414D\"")
            .contains("fsType = \"vfat\"")
            ...
            .contains("\${localRomsMount}:/ROMs-local:ro")
            .contains("\${localGamesMount}:/games-local:ro")
            .contains("d \${localGamesMount}/imports/t1000")
