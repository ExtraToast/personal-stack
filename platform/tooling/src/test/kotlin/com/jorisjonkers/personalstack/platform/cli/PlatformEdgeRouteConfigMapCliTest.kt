...
class PlatformEdgeRouteConfigMapCliTest {
    private val repositoryRoot = RepositoryRootLocator().locate()

    @Test
    fun `render-edge-route-configmap matches the committed flux artifact`() {
        ...
        val exitCode =
            ...
            ).run("render-edge-route-configmap")

        assertThat(exitCode).isEqualTo(0)
        val expectedArtifact = repositoryRoot.resolve("platform/cluster/flux/apps/edge/edge-route-catalog-configmap.yaml").toFile().readText()
